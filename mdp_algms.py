...
single or multiple discount factors, finite or infinite horizons, does rewrad depend
on the next state etc.
"""
...
def policy_eval_diff_discount_factors(states, i_timestep, horizon, reward_func_last, effort_func_last, reward_func, effort_func,
    ...
    '''
    algorithm for evaluating an arbitrary policy at a timestep given task structure 
    (i.e, rewards and efforts, discount factors, transition matrices, states, finite horizon). 
    This is for the case with different discount factors
    '''
